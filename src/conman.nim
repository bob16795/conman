...
proc setup() =
  ...
  wa.event_mask = ( SubstructureRedirectMask or SubstructureNotifyMask or
    ButtonPressMask or PointerMotionMask or EnterWindowMask or
    LeaveWindowMask or StructureNotifyMask or PropertyChangeMask)
  discard XChangeWindowAttributes(dpy, root, CWEventMask or CWCursor, addr wa)
  discard XSelectInput(dpy, root, wa.event_mask)
